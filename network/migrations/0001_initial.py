...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['follower'], name='network_fol_followe_7f2106_idx'), models.Index(fields=['following'], name='network_fol_followi_8ea059_idx')],
                'constraints': [models.UniqueConstraint(fields=('follower', 'following'), name='unique_follow')],
            },
        ),
        migrations.AddIndex(
            model_name='post',
            index=models.Index(fields=['timestamp'], name='network_pos_timesta_0f988b_idx'),
        ),
        migrations.AddIndex(
            model_name='post',
